...
import com.example.library.view.webView.config.FullscreenHolder;
import com.example.library.view.webView.config.IWebPageView;
import com.example.library.view.webView.config.MyJavascriptInterface;
import com.example.library.view.webView.config.MyWebChromeClient;
import com.example.library.view.webView.config.MyWebViewClient;
...
//                break;
    ...
    private void initWebView() {
        ...
        WebUtils.getCommonWebSetting(webView);
